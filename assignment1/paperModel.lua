...
elseif opt.model == 'convnet' then
   ...
   if opt.type == 'cuda' then
      ...
      c = nn.Parallel(nfeats,nstates[2])
      model = nn.Sequential();
      ...
      model2:add(nn.SpatialConvolutionMM(nstates[1], nstates[2], filtsize, filtsize))
      model2:add(nn.Tanh())
      ...
      -- stage 3 : standard 2-layer neural network
      -- model:add(nn.SpatialSubtractiveNormalization(nstates[1]+nstates[2], normkernel))
